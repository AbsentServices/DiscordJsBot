...
exports.run = async (client, message, args) => {
    ...
    const a = message.guild.roles.get('615639898141097995'); // Moderator
    const b = message.guild.roles.get('615639907783933972'); // Administrator
    const c = message.guild.roles.get('615639909406998633'); // Developer
    ...
    message.channel.send(embed).then(async msg => {
        ...
        msg.awaitReactions(filter, { /**Need to remove time or make it last forever**/
            max: 10,
            time: 30000, 
            errors: ['time']
        }).then(collected => {
